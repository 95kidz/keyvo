...
const RewardsPage = () => {
  ...
  const userPoints = 500; // Simulated user points

  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Catalogue des Récompenses</h1>
        <p className="mt-2 text-gray-600">Échangez vos Eco Coins contre des récompenses exclusives</p>
      </div>
